...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1537: x0 => x0.length,
      _1695: (x0,x1) => x0.querySelector(x1),
      _1696: (x0,x1) => x0.createElement(x1),
      _1697: (x0,x1) => x0.querySelector(x1),
      _1725: x0 => new Array(x0),
      _1727: x0 => x0.length,
      _1729: (x0,x1) => x0[x1],
      _1730: (x0,x1,x2) => x0[x1] = x2,
      _1733: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1735: x0 => new Int8Array(x0),
      _1736: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1737: x0 => new Uint8Array(x0),
      _1745: x0 => new Int32Array(x0),
      _1749: x0 => new Float32Array(x0),
      _1751: x0 => new Float64Array(x0),
      _1753: (o, c) => o instanceof c,
      ...
      _1762: (o, a) => o + a,
      _1783: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1784: () => new TextDecoder("utf-8", {fatal: true}),
      _1785: () => new TextDecoder("utf-8", {fatal: false}),
      _1786: x0 => new WeakRef(x0),
      _1787: x0 => x0.deref(),
      _1793: Date.now,
      _1795: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1796: s => {
      ...
      _1798: () => typeof dartUseDateNowForTicks !== "undefined",
      _1799: () => 1000 * performance.now(),
      _1800: () => Date.now(),
      _1801: () => {
      ...
      _1803: () => new WeakMap(),
      _1804: (map, o) => map.get(o),
      _1805: (map, o, v) => map.set(o, v),
      _1806: () => globalThis.WeakRef,
      _1817: s => JSON.stringify(s),
      _1818: s => printToConsole(s),
      _1819: a => a.join(''),
      _1822: (s, t) => s.split(t),
      _1823: s => s.toLowerCase(),
      _1824: s => s.toUpperCase(),
      _1825: s => s.trim(),
      _1826: s => s.trimLeft(),
      _1827: s => s.trimRight(),
      _1829: (s, p, i) => s.indexOf(p, i),
      _1830: (s, p, i) => s.lastIndexOf(p, i),
      _1832: Object.is,
      _1833: s => s.toUpperCase(),
      _1834: s => s.toLowerCase(),
      _1835: (a, i) => a.push(i),
      _1839: a => a.pop(),
      _1840: (a, i) => a.splice(i, 1),
      _1842: (a, s) => a.join(s),
      _1843: (a, s, e) => a.slice(s, e),
      _1846: a => a.length,
      _1848: (a, i) => a[i],
      _1849: (a, i, v) => a[i] = v,
      _1851: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1852: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1853: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1854: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      ...
      _1857: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1858: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1860: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1861: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1862: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1863: (t, s) => t.set(s),
      _1865: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1867: o => o.buffer,
      _1868: o => o.byteOffset,
      _1869: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1870: (b, o) => new DataView(b, o),
      _1871: (b, o, l) => new DataView(b, o, l),
      _1872: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1873: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1874: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1875: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1876: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1877: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1878: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1879: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1880: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1881: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1882: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1883: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1886: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1887: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1888: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1889: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1890: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1891: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1904: (o, t) => o instanceof t,
      ...
      _1910: (handle) => clearTimeout(handle),
      _1913: (c) =>
      ...
      _1944: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1945: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1969: (x0,x1) => x0.appendChild(x1),
      _1970: (x0,x1) => x0.item(x1),
      _1971: x0 => globalThis.fetch(x0),
      _1972: (x0,x1) => globalThis.WebAssembly.instantiateStreaming(x0,x1),
      _1975: x0 => globalThis.createTdwebModule(x0),
      _1976: (x0,x1) => x0.append(x1),
      _1977: (x0,x1) => x0.append(x1),
      _1993: (s, m) => {
        try {
      ...
      _1995: (x0,x1) => x0.test(x1),
      _1996: (x0,x1) => x0.exec(x1),
      _1997: (x0,x1) => x0.exec(x1),
      _1998: x0 => x0.pop(),
      _2000: o => o === undefined,
      _2019: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _2021: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _2022: o => o instanceof RegExp,
      _2023: (l, r) => l === r,
      _2024: o => o,
      _2025: o => o,
      _2026: o => o,
      ...
      _2033: l => arrayFromDartList(Int8Array, l),
      _2034: l => arrayFromDartList(Uint8Array, l),
      _2035: l => arrayFromDartList(Uint8ClampedArray, l),
      _2036: l => arrayFromDartList(Int16Array, l),
      _2037: l => arrayFromDartList(Uint16Array, l),
      _2038: l => arrayFromDartList(Int32Array, l),
      _2039: l => arrayFromDartList(Uint32Array, l),
      _2040: l => arrayFromDartList(Float32Array, l),
      _2041: l => arrayFromDartList(Float64Array, l),
      _2042: x0 => new ArrayBuffer(x0),
      _2043: (data, length) => {
      ...
      _2044: l => arrayFromDartList(Array, l),
      _2045: () => ({}),
      _2046: () => [],
      _2047: l => new Array(l),
      _2048: () => globalThis,
      ...
      _2071: x0 => x0.index,
      _2076: x0 => x0.flags,
      _2077: x0 => x0.multiline,
      _2078: x0 => x0.ignoreCase,
      _2079: x0 => x0.unicode,
      _2080: x0 => x0.dotAll,
      _2081: (x0,x1) => x0.lastIndex = x1,
      _2082: (o, p) => p in o,
      _2083: (o, p) => o[p],
      _2086: x0 => x0.random(),
      _2087: x0 => x0.random(),
      _2091: () => globalThis.Math,
      _2093: Function.prototype.call.bind(Number.prototype.toString),
      _2094: (d, digits) => d.toFixed(digits),
      _3541: x0 => x0.src,
      _3542: (x0,x1) => x0.src = x1,
      _3544: (x0,x1) => x0.type = x1,
      _3548: (x0,x1) => x0.async = x1,
      _3562: (x0,x1) => x0.charset = x1,
      _4029: () => globalThis.window,
      _4094: x0 => x0.navigator,
      _4466: x0 => x0.geolocation,
      _4469: x0 => x0.mediaDevices,
      _4471: x0 => x0.permissions,
      _6745: x0 => x0.length,
      _6811: () => globalThis.document,
      _6906: x0 => x0.head,
      _7255: (x0,x1) => x0.id = x1,
      _7282: x0 => x0.children,
